...
<link rel="stylesheet" href="resources/css/CorrectionNewsPageStyles.css">
...
<div class="main-block-header">
	...
	<!-- Поле для создание новости -->
	
	<h1 class="myCreate_news"> ${filldate}</h1>
	<div class="create_news_area">
		<div class="create_news_area_title">
			<form action="Controller" method="post"> 
				<input	type="hidden" name="command" value="PUBLISH_NEWS" />
				<input type="hidden" name="newsId" value='${requestScope["news"].getNewsId()}' />
				<p><strong>${title}</strong><br>
				  <input class="input_creat_news" size="50" type="text" name="title" value='${requestScope["news"].getTitle()}' >
  				</p>
				<p><strong>${brief}</strong><br>
				
				  <input class="input_creat_news" size="60" type="text" name="brief" value='${requestScope["news"].getBrief()}' >
  				</p>
				<p><strong>${content}</strong><br>
					<textarea  rows="10" cols="90" name ="content"> '${requestScope["news"].getContent()}'</textarea>
  				</p>		 
